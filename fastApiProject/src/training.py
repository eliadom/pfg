...
def processa_dades(nomexcel):
    ...
    # batch_size = 100
    batch_size = 150
    steps_per_epock = int(len(X_mostres)/batch_size)*2

    # lstm_model.fit(X_mostres, y_mostres, epochs=700, batch_size=batch_size, steps_per_epoch=steps_per_epock, verbose=2)
    lstm_model.fit(X_mostres, y_mostres, epochs=300, batch_size=batch_size, steps_per_epoch=steps_per_epock, verbose=2)
    ...
    #
    # lstm_score = r2_score(y_mostres, lstm_predictions)
